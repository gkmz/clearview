...
enum AppCopy {
    ...
    enum ReminderPopup {
        ...
        static let pomodoroLongPreparingTitle = "这一组番茄完成，准备长休息"
        static let pomodoroRestingTitle = "休息时间，先看看远方"
        static let pomodoroLongRestingTitle = "长休息时间，放松一下"
        ...
        static let pomodoroLongPreparingMessage = "这一组专注完成了，先远眺，再好好休息。"
        static let pomodoroRestingMessage = "前几十秒远眺，后面自由放松。"
        static let pomodoroLongRestingMessage = "前几十秒远眺，接下来离开屏幕放松一会儿。"
        static let completedMessage = "慢慢回来，保持节奏，记得继续舒眼哦"
        static let pomodoroCompletedMessage = "休息结束，准备进入下一轮专注。"
        static let pomodoroLongCompletedMessage = "长休息结束，准备开始新的一组专注。"
